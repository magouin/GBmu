...
{0b01000110, "BIT 0, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 0)}, \
...
{0b01001110, "BIT 1, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 1)}, \
...
{0b01010110, "BIT 2, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 2)}, \
...
{0b01011110, "BIT 3, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 3)}, \
...
{0b01100110, "BIT 4, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 4)}, \
...
{0b01101110, "BIT 5, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 5)}, \
...
{0b01110110, "BIT 6, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 6)}, \
...
{0b01111110, "BIT 7, (HL)", 1, {_, SET_1, SET_0, SET}, 4, std::bind(&Emulateur::bit, this, &p_HL_D1, 7)}, \
