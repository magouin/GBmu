...
{0b00000110, "RLC (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::rlc, this, &p_HL_D1)}, \
...
{0b00001110, "RRC (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::rrc, this, &p_HL_D1)}, \
...
{0b00010110, "RL (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::rl, this, &p_HL_D1)}, \
...
{0b00011110, "RR (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::rr, this, &p_HL_D1)}, \
...
{0b00100110, "SLA (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::sla, this, &p_HL_D1)}, \
...
{0b00101110, "SRA (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::sra, this, &p_HL_D1)}, \
...
{0b00110110, "SWAP (HL)", 1, {SET_0, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::_swap, this, &p_HL_D1)}, \
...
{0b00111110, "SRL (HL)", 1, {SET, SET_0, SET_0, SET}, 3, std::bind(&Emulateur::srl, this, &p_HL_D1)}, \
...
{0b10000110, "RES 0, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 0)}, \
...
{0b10001110, "RES 1, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 1)}, \
...
{0b10010110, "RES 2, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 2)}, \
...
{0b10011110, "RES 3, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 3)}, \
...
{0b10100110, "RES 4, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 4)}, \
...
{0b10101110, "RES 5, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 5)}, \
...
{0b10110110, "RES 6, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 6)}, \
...
{0b10111110, "RES 7, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::res, this, &p_HL_D1, 7)}, \
...
{0b11000110, "SET 0, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 0)}, \
...
{0b11001110, "SET 1, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 1)}, \
...
{0b11010110, "SET 2, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 2)}, \
...
{0b11011110, "SET 3, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 3)}, \
...
{0b11100110, "SET 4, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 4)}, \
...
{0b11101110, "SET 5, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 5)}, \
...
{0b11110110, "SET 6, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 6)}, \
...
{0b11111110, "SET 7, (HL)", 1, {_, SET_1, SET_0, _}, 3, std::bind(&Emulateur::set, this, &p_HL_D1, 7)}, \
